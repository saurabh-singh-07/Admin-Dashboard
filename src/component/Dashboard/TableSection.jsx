...
function TableSection() {
    const getStatusColor = (status) =>{
        switch(status){
            case "completed":
                return "bg-emerald-100 text-emerald-700 dark:text-emerald-400 dark:bg-emerald-900/30";
            case "pending":
  ...
  return (
    <div className='space-y-6'>
        <div className='bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-b-2xl border border-slate-200/50 dark:border-slate-200/50 overflow-hidden '>
            <div className='p-6 border-b flex justify-between border-slate-200/50 dark:border-slate-700/50 '>
                <div>
                    <h3 className='text-lg fond-bold text-slate-800 dark:text-white'> Recent Orders</h3>
